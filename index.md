...
- [1. 组件架构概述](board_manager.md#1-组件架构概述)
  - [1.1 系统框图](board_manager.md#11-系统框图)
...
- [2. 核心数据结构](board_manager.md#2-核心数据结构)
  ...
  - [2.5 esp_board_entry 静态注册机制](board_manager.md#25-esp_board_entry-静态注册机制)
...
- [设备使用指南](device_use.md) - 详细介绍外设初始化后如何使用各类设备（LCD、音频、摄像头、存储等）
